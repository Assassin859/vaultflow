...
export function useLendingPoolRead(functionName: string, args?: readonly any[]) {
...
export function useERC20Read(address: string, functionName: string, args?: readonly any[]) {
  return useReadContract({
...
export function usePriceOracleRead(functionName: string, args?: readonly any[]) {
  return useReadContract({
