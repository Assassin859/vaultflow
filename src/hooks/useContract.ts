...
export function useLendingPoolRead(functionName: string, args?: readonly unknown[]) {
...
export function useERC20Read(address: string, functionName: string, args?: readonly unknown[]) {
  return useReadContract({
...
export function usePriceOracleRead(functionName: string, args?: readonly unknown[]) {
  return useReadContract({
