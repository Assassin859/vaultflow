import{i as ve,p as fe,s as ge,j as be,M as g,S as se,R as l,k as v,l as P,m as f,x as a,A as K,n as ce,o as le,C as m,q as Y,u as ye,v as S,E as ie,O as E,y as q,z as oe,B as T,D as H,T as xe,F as Ce,G as ke,I as Se}from"./core-2oFqdo1n.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-C6STKTok.js";import"./index-B6BlJjIh.js";import"./events-CYUWQnCq.js";import"./index.es-CWHroG-p.js";import"./index-nibyPLVP.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
